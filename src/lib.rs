...
#[derive(Debug)]
pub struct KeyMeshProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KeyMeshProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KeyMesh processing");
    
    let mut processor = KeyMeshProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KeyMeshProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KeyMeshProcessor::new(false);
